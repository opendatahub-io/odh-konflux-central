#!/usr/bin/env python3
"""Tekton step: resolve opendatahub-tests image for any install/cluster path."""
...
from steps.resolve_opendatahub_tests_image import main as resolve_main  # noqa: E402
...
def main() -> int:
    ...
    if ver:
        ...
        print(f"Using operator version {ver!r} for opendatahub-tests image resolve")
