...
Deletes ``STALE_TESTOPS_PLAYPEN_ITS_NAMES`` (``suite/constants.py`` / ``config/rhoai-e2e-stale-its.yaml``).
...
Usage:
  python3 integration-tests/rhoai-e2e/runners/report/prune_stale_testops_its.py
  python3 integration-tests/rhoai-e2e/runners/report/prune_stale_testops_its.py -n my-tenant
"""
...
from suite.constants import DEFAULT_NAMESPACE, STALE_TESTOPS_PLAYPEN_ITS_NAMES
